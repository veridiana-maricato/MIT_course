...
def verify_num_input(input):
    if not input.isnumeric():
        print("Please enter a number using only numerical digits, dear.")

    if input > 15:
        print(f"Oh wow, I think {input} guesses is a bit much, don't you? How about choosing a number smaller then 15? We don't have that many letters in our ABC...")
...
def welcome_to_game():
    ...
    time.sleep(1)
    print(f"How many guesses would you like to start with, dear {user_name}? Our recommendation is 6.")
