...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    # partial_word = get_guessed_word(secret_word, "abc")

    letter_guessed = input("Make a guess: ")
    if not len(letter_guessed) == 1 or not type(letter_guessed) == "string":
        letter_guessed = input("Please write only one letter: ")
    assert len(letter_guessed) == 1
